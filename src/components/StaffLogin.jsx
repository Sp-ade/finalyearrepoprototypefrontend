    ...
    return (<>
        <Box sx={{ bgcolor: '#f5f5f5', minHeight: '70vh', display: 'flex', alignItems: 'center', py: 6 }}>
            <Container maxWidth="md">
                <Paper elevation={3} sx={{ display: 'flex', borderRadius: "0px 20px 0px 0px", flexDirection: { xs: 'column', md: 'row' }, minHeight: 420 }}>
                    {/* Left: image/design */}
                    <Box sx={{
                        flex: 1,
                        display: 'flex',
                        ...
                        <Typography variant="h6" align="center">Place your staff design or image here</Typography>
                    </Box>

                    {/* Right: form */}
                    <Box sx={{ width: '43%' }} component="form" onSubmit={handleSubmit}>
                        <Box sx={{ mb: 2, background: 'linear-gradient(90deg, #1354c5ff 0%, #1262ecff 60%)', color: '#fff', p: 2, borderRadius: "1px 20px 1px 1px", height: '40px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                            <Typography sx={{ color: '#ffffff', fontSize: '1.7rem' }}>Staff Login</Typography>
                        </Box>
