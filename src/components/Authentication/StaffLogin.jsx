  ...
  return (
    <Box sx={{
      ...
      <Paper elevation={0} sx={{
        ...
        <Typography variant="h5" sx={{ fontWeight: 800, color: '#000', mb: 0.5, fontSize: { xs: '1.25rem', sm: '1.5rem' } }}>Staff Portal</Typography>
        <Typography variant="body2" sx={{ color: '#718096', mb: 3, fontSize: '0.9rem' }}>Secure Access for Supervisors</Typography>

        <Box component="form" onSubmit={handleSubmit} sx={{ textAlign: 'left' }}>
          <Typography variant="subtitle2" sx={{ mb: 0.5, fontWeight: 700, color: '#000', fontSize: '0.9rem' }}>Staff Email</Typography>
          <TextField
            fullWidth placeholder="staff.name@nileuniversity.edu.ng"
            size="small"
            value={userName}
            onChange={(e) => setUserName(e.target.value)}
            sx={{ mb: 2, '& .MuiOutlinedInput-root': { borderRadius: 2, bgcolor: '#f7f9fc', '& fieldset': { borderColor: '#e2e8f0' } } }}
          />
          ...
          <TextField
            ...
            sx={{ mb: 1, '& .MuiOutlinedInput-root': { borderRadius: 2, bgcolor: '#f7f9fc', '& fieldset': { borderColor: '#e2e8f0' } } }}
          />
          ...
          <Button
            ...
            sx={{ py: 1.2, borderRadius: 2, bgcolor: '#2b4593', textTransform: 'none', fontSize: '1rem', fontWeight: 600, mb: 2 }}
          >
        ...
        <Box sx={{ mt: 2 }}>
          ...
          <Typography onClick={onSwitch} sx={{ color: '#2b4593', cursor: 'pointer', fontWeight: 600, fontSize: '1rem', mb: 1 }}>
